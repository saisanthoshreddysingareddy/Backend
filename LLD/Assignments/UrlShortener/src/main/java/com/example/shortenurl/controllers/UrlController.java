...
public class UrlController {
    ...
    public ShortenUrlResponseDto shortenUrl(
    ...
    public ResolveShortenUrlResponseDto resolveShortenedUrl(
            ResolveShortenUrlRequestDto requestDto) {

        ResolveShortenUrlResponseDto responseDto =
                new ResolveShortenUrlResponseDto();

        try {

            String originalUrl =
                    urlService.resolveShortenedUrl(
                            requestDto.getShortenUrl());
